...
type WatchdogCommand string

const (
	WatchdogCommandDoRequest          WatchdogCommand = "doreq"
	WatchDogCommandSetMacProc         WatchdogCommand = "setproc"
	WatchDogCommandCommandSetMemBytes WatchdogCommand = "setmeml"
	WatchDogCommandExit               WatchdogCommand = "exit"
)
